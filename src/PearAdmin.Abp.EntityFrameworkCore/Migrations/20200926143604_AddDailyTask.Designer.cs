...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PearAdmin.Abp.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PearAdmin.Abp.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PearAdmin.Abp.Chat.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PearAdmin.Abp.DataDictionaries.DataDictionaryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PearAdmin.Abp.Friendships.Friendship", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("PearAdmin.Abp.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PearAdmin.Abp.Storage.BinaryObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("PearAdmin.Abp.TaskCenters.DailyTasks.DailyTask", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("PearAdmin.Abp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("PearAdmin.Abp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("PearAdmin.Abp.Authorization.Roles.Role", b =>
                {
                    b.HasOne("PearAdmin.Abp.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("PearAdmin.Abp.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("PearAdmin.Abp.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PearAdmin.Abp.TaskCenters.DailyTasks.DailyTask", b =>
                {
                    b.OwnsOne("PearAdmin.Abp.TaskCenters.DailyTasks.ValueObjects.DateRange", "DateRange", b1 =>
                        {
                    ...
                    b.OwnsOne("PearAdmin.Abp.TaskCenters.DailyTasks.ValueObjects.TaskState", "TaskState", b1 =>
                        {
                            b1.Property<Guid>("DailyTaskId")
                                .HasColumnType("char(36)");
