...
namespace PearAdmin.Abp.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!AbpCoreConsts.AllowTenantsToChangeEmailSettings)
            {
        ...
        private IEnumerable<SettingDefinition> GetTenantSettings()
        {
            return new[]
            {
                ...
                new SettingDefinition(AppSettingNames.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettingNames(AppSettingNames.Email.UseHostDefaultEmailSettings, AbpCoreConsts.MultiTenancyEnabled.ToString()), scopes: SettingScopes.Tenant)
            };
        }
