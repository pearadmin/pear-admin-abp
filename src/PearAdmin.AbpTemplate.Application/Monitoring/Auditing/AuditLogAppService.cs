...
using PearAdmin.AbpTemplate.Auditing.Exporting;
...
using PearAdmin.AbpTemplate.EntityHistory;
using EntityHistoryHelper = PearAdmin.AbpTemplate.EntityHistory.EntityHistoryHelper;

namespace PearAdmin.AbpTemplate.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissionNames.Pages_SystemManagement_AuditLogs)]
    public class AuditLogAppService : AbpTemplateApplicationServiceBase, IAuditLogAppService
    {
        #region Init
        ...
        public async Task<PagedResultDto<AuditLogListDto>> GetAuditLogList(GetPagedAuditLogsInput input)
        {
        ...
        public async Task<FileDto> GetAuditLogsToExcel(GetPagedAuditLogsInput input)
        {
        ...
        private IQueryable<AuditLogAndUser> CreateAuditLogAndUsersQuery(GetPagedAuditLogsInput input)
        {
