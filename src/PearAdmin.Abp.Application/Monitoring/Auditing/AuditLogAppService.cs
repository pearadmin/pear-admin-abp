...
using PearAdmin.Abp.Auditing.Exporting;
using PearAdmin.Abp.Authorization;
using PearAdmin.Abp.Authorization.Users;
using PearAdmin.Abp.CommonDto;
using PearAdmin.Abp.EntityHistory;
using EntityHistoryHelper = PearAdmin.Abp.EntityHistory.EntityHistoryHelper;

namespace PearAdmin.Abp.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissionNames.Pages_SystemManagement_AuditLogs)]
    public class AuditLogAppService : AbpApplicationServiceBase, IAuditLogAppService
    {
        #region Init
