...
namespace PearAdmin.Abp.MultiTenancy.TenantSetting
{
    ...
    public class TenantSettingsAppService : AbpApplicationServiceBase, ITenantSettingsAppService
    {
        ...
        {
            if (_multiTenancyConfig.IsEnabled && !AbpCoreConsts.AllowTenantsToChangeEmailSettings)
            {
                return;
            }
