...
{
    public class UserAppService : AbpApplicationServiceBase, IUserAppService
    {
        ...
        public async Task CreateUser(CreateUserDto input)
        {
            ...
            {
                CheckErrors(await validator.ValidateAsync(UserManager, user, AbpApplicationConsts.DefaultPassword));
            }

            user.Password = _passwordHasher.HashPassword(user, AbpApplicationConsts.DefaultPassword);
            ...
            CheckErrors(await UserManager.CreateAsync(user, AbpApplicationConsts.DefaultPassword));
