...
{
    [AbpAuthorize]
    public class ProfileAppService : AbpApplicationServiceBase, IProfileAppService
    {
        ...
        public async Task UpdateProfilePicture(UpdateProfilePictureInput input)
        {
            ...
            {
                throw new UserFriendlyException(L("ResizedProfilePicture_Warn_SizeLimit", AbpApplicationConsts.ResizedMaxProfilPictureBytesUserFriendlyValue));
            }
