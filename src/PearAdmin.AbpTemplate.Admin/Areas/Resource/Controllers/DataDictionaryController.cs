...
using PearAdmin.AbpTemplate.Admin.Areas.Resource.Models.DataDictionaries;

namespace PearAdmin.AbpTemplate.Admin.Areas.Resource.Controllers
{
    /// <summary>
    /// 数据字典控制器
    /// </summary>
    [Area("Resource")]
    [AbpMvcAuthorize]
    public class DataDictionaryController : AbpTemplateControllerBase
    {
