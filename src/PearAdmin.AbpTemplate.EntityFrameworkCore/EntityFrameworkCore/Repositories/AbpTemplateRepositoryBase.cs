...
namespace PearAdmin.AbpTemplate.EntityFrameworkCore.Repositories
{
    ...
    /// <summary>
    /// Base class for custom repositories of the application.
    /// This is a shortcut of <see cref="AbpTemplateRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract class AbpTemplateRepositoryBase<TEntity> : AbpTemplateRepositoryBase<TEntity, int>, IRepository<TEntity>
